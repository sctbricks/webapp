...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      />
      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 border-b border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="md:hidden flex items-center gap-3">
            <a href={getWhatsAppUrl("Hello SCT Bricks, I need some information.")} target="_blank" rel="noopener noreferrer" className="text-brand-accent">
